...
pwtx <- read.csv("~/Downloads/pwt81.csv")
str(pwtx)
...
pwtx1 <- subset(pwtx, select = c(countrycode, year, rgdpe, rgdpo, rkna, wagee, wageo, rconna))
pwtx0 <- subset(pwtx, select = c(year, rgdpe, rgdpo, rkna, wagee, wageo, rconna))
...
# This computes national 'Profit share,' national 'Capital productivity'
# national 'Rate of exploitation,' and national 'Profit rate':
...
# Density plots:
plot.multi.dens(list(rgdpe61,rgdpe71,rgdpe81,rgdpe91,rgdpe01,rgdpe11))
...
plot.multi.dens(list(rgdpo61,rgdpo71,rgdpo81,rgdpo91,rgdpo01,rgdpo11))
title(main = "K-density of log of Real GDP(o) (Value Added)")
le <- largest.empty(rgdpo61,rgdpo11,.1,.1)
legend(le,legend=c("1961","1971","1981","1991","2001","2011"), lwd=(1:6), lty =(1:6))

plot.multi.dens(list(wagee61,wagee71,wagee81,wagee91,wagee01,wagee11))
title(main = "K-density of log of Wages (Variable Capital)")
le <- largest.empty(wagee61,wagee11,.1,.1)
legend(le,legend=c("1961","1971","1981","1991","2001","2011"), lwd=(1:6), lty =(1:6))
