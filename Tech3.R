...
wdi2 <- read.csv("~/Downloads/WDI2.csv")
View(wdi2)
str(wdi2)
...
# Bank capital to assets ratio (%)
plot(wwdifin$year, wwdifin$FB.BNK.CAPA.ZS, xlab="year", ylim=c(0,12), xlim = c(1999,2013), ylab="", type="s", main="Bank capital to assets ratio (%)", sub="World, Source: WDI")

# Bank nonperforming loans to total gross loans (%)
plot(wwdifin$year, wwdifin$FB.AST.NPER.ZS, xlab="year", ylim=c(0,11), xlim = c(1999,2013), ylab="", type="s", main="Bank nonperforming loans to total gross loans (%)", sub="World, Source: WDI")

# Claims on central government, etc. (% GDP)
plot(wwdifin$year, wwdifin$FS.AST.CGOV.GD.ZS, xlab="year", ylim=c(0,30), ylab="", type="s", main="Claims on central government, etc. (% GDP)", sub="World, Source: WDI")

# Claims on other sectors of the domestic economy (% of GDP)
plot(wwdifin$year, wwdifin$FS.AST.DOMO.GD.ZS, xlab="year", ylim=c(0,155), xlim = c(1999,2013), ylab="", type="s", main="Claims on other sectors of the domestic economy (% of GDP)", sub="World, Source: WDI")

# Domestic credit provided by financial sector (% of GDP)
plot(wwdifin$year, wwdifin$FS.AST.DOMS.GD.ZS, xlab="year", ylim=c(0,170), ylab="", type="s", main="Domestic credit provided by financial sector (% of GDP)", sub="World, Source: WDI")

# Domestic credit to private sector (% of GDP)
plot(wwdifin$year, wwdifin$FS.AST.PRVT.GD.ZS, xlab="year", ylim=c(0,140), ylab="", type="s", main="Domestic credit to private sector (% of GDP)", sub="World, Source: WDI")

# Domestic credit to private sector by banks (% of GDP)
plot(wwdifin$year, wwdifin$FD.AST.PRVT.GD.ZS, xlab="year", ylim=c(0,100), ylab="", type="s", main="Domestic credit to private sector by banks (% of GDP)", sub="World, Source: WDI")

# End


# Example to aggregate using two criteria:
