...
pwt9$K <- pwt9$rkna
pwt9no <- pwt9
pwt9no$c[pwt9no$c<0 | pwt9no$c>1] <- NA
summary(pwt9no) # dataframe with no c outliers
pwt9no$C <- (pwt9no$c * pwt9no$Yo) # Consumption
summary(pwt9no) # dataframe with no c outliers
...
yruwlabsh <-tapply(pwt9no$labsh, pwt9no$year, mean, na.rm=TRUE)
yruwc<-tapply(pwt9no$csh_c, pwt9no$year, mean, na.rm=TRUE)
plot(c(1950:2014),yruwlabsh, type="l", col="black", lwd=3,  main="Int'l (unweighted mean) W/Y and C/Yo", sub="Source: PWT 9.0", xlab="Year", ylim=c(.5,.7))
lines(c(1950:2014),yruwc, type="l", col="black", lwd=1)
...
yruwrho<-tapply(pwt9no$rho, pwt9no$year, mean, na.rm=TRUE)
plot(c(1950:2014), yruwrho, type="l", col="black", lwd=2,  main="Int'l (unweighted mean) Y/K", sub="Source: PWT 9.0", xlab="Year", ylab=" ")
abline(h=mean(yruwrho),lty=2, lwd=1)
legend("bottomleft", "1950-2011 Mean of (unw int'l mean) rho",lty=2, lwd=1,col="black")

yruwe<-tapply(pwt9no$e, pwt9no$year, mean, na.rm=TRUE)
yruweps <-tapply(pwt9no$eps, pwt9no$year, mean, na.rm=TRUE)
plot(c(1950:2014),yruwe, type="l", col="black", lwd=3,  main="Int'l (unweighted mean) (Y-W)/W and (Yo-C)/C", sub="Source: PWT 9.0", xlab="Year", ylab="", ylim=c(.5,1.2))
lines(c(1950:2014),yruweps, type="l", col="black", lwd=1)
legend("topleft", c("e=(Y-W)/W","epsilon=(Yo-C)/C"), lty=c(1,1), lwd=c(3,1),col=c("black","black"))

yruwr <-tapply(pwt9no$r, pwt9no$year, mean, na.rm=TRUE)
yruwkap <-tapply(pwt9no$kap, pwt9no$year, mean, na.rm=TRUE)
plot(c(1950:2014), yruwrho, type="l", col="black", lwd=3,  main="Int'l (unweighted mean) Y/K, (Y-W)/K, and (Yo-C)/K", sub="Source: PWT 9.0", xlab="Year", ylab=" ", ylim=c(0.1,0.6))
lines(c(1950:2014),yruwr, type="l", col="black", lwd=2)
lines(c(1950:2014),yruwkap, type="l", col="black", lwd=1)
...
pwt9g$yruwlabsh <- yruwlabsh
pwt9g$yrc <- yrc
pwt9g$yruwc <- yruwc
pwt9g$yruwe <- yruwe
pwt9g$yruweps <- yruweps
pwt9g$yruwrho <- yruwrho
pwt9g$yruwr <- yruwr
pwt9g$yruwkap <- yruwkap
...
cor(pwt9g$yrY,pwt9g$Y)
cor(pwt9g$yrrgdpo,pwt9g$rgdpo)
cor(pwt9g$yrK,pwt9g$rkna)
cor(pwt9g$yrW,pwt9g$W)
cor(pwt9g$yrC,pwt9g$C)
cor(pwt9g$yrL,pwt9g$L)
cor(pwt9g$yraL,pwt9g$aL)
cor(pwt9g$yryal,pwt9g$yal)
cor(pwt9g$yrlabsh,pwt9g$labsh)
cor(pwt9g$yrc,pwt9g$c)

cor(pwt9g$yruwe,pwt9g$e)
cor(pwt9g$yruweps,pwt9g$eps)
cor(pwt9g$yruwrho,pwt9g$rho)
cor(pwt9g$yruwr,pwt9g$r)
cor(pwt9g$yruwkap,pwt9g$kap)
...
pwt9nwg$ww <- pwt9nwg$wW/pwt9nwg$wY # n-weighted omega
pwt9nwg$we <- (pwt9nwg$wY-pwt9nwg$wW)/pwt9nwg$wW # n-weighted e
pwt9nwg$wc <- pwt9nwg$wC/pwt9nwg$wrgdpo # n-weighted c
pwt9nwg$weps <- (pwt9nwg$wrgdpo-pwt9nwg$wC)/pwt9nwg$wC # n-weighted epsilon
pwt9nwg$wrho <- pwt9nwg$wY/pwt9nwg$wK # n-weighted rho
pwt9nwg$wr <- (pwt9nwg$wY-pwt9nwg$wW)/pwt9nwg$wK # n-weighted r
pwt9nwg$wkap <- (pwt9nwg$wrgdpo-pwt9nwg$wC)/pwt9nwg$wK # n-weighted kappa

pwt9g$wlabsh <- pwt9nwg$ww
pwt9g$wc <- pwt9nwg$wc
pwt9g$we <- pwt9nwg$we
pwt9g$weps <- pwt9nwg$weps
pwt9g$wrho <- pwt9nwg$wrho
pwt9g$wr <- pwt9nwg$wr
pwt9g$wkap <- pwt9nwg$wkap

plot(c(1950:2014),pwt9g$e,  type="l", col="black", lwd=3, main="Global, nw int'l, and uw int'l (Y-W)/W", sub="Source: PWT 9.0", xlab="Year", ylab=" ", ylim=c(.2,1.2))
lines(c(1950:2014), pwt9g$we, type="l", lwd=2, col="black")
lines(c(1950:2014), pwt9g$yruwe, type="l", lwd=1, col="black")
legend("topleft", c("Global (Y-W)/W","Int'l uw (Y-W)/W", "Int'l nw (Y-W)/W"), lwd=c(3,2,1), col=c("black","black", "black"))

plot(c(1950:2014), pwt9g$eps,  type="l", col="black", lwd=3, main="Global, nw int'l, and uw int'l (Yo-C)/C", sub="Source: PWT 9.0", xlab="Year", ylab=" ", ylim=c(.4,1.2))
lines(c(1950:2014), pwt9g$weps, type="l", lwd=2, col="black")
lines(c(1950:2014), pwt9g$yruweps, type="l", lwd=1, col="black")
legend("topleft", c("Global (Yo-C)/C", "Int'l nw (Yo-C)/C","Int'l uw (Yo-C)/C"), lwd=c(3,2,1), col=c("black","black", "black"))

plot(c(1950:2014),pwt9g$rho,  type="l", col="black", lwd=3, main="Global, nw int'l, and uw int'l Y/K", sub="Source: PWT 9.0", xlab="Year", ylab=" ", ylim=c(.2,.6))
lines(c(1950:2014), pwt9g$wrho, type="l", lwd=2, col="black")
lines(c(1950:2014), pwt9g$yruwrho, type="l", lwd=1, col="black")
legend("topright", c("Global Y/K","Int'l nw Y/K","Int'l uw Y/K"), lwd=c(3,2,1), col=c("black","black", "black"))

plot(c(1950:2014),pwt9g$r,  type="l", col="black", lwd=3, main="Global, nw int'l, and uw int'l (Y-W)/K", sub="Source: PWT 9.0", xlab="Year", ylab=" ", ylim=c(.05,.3))
lines(c(1950:2014), pwt9g$wr, type="l", lwd=2, col="black")
lines(c(1950:2014), pwt9g$yruwr, type="l", lwd=1, col="black")
legend("topright", c("Global (Y-W)/K","Int'l nw (Y-W)/K","Int'l uw (Y-W)/K"), lwd=c(3,2,1), col=c("black","black", "black"))
# The increase in uw r in 1970 didn't translate into an increase in global r
# because it was an uw increase in rho, but not in global rho.  However,
# the increase in uw r in the late 2000s did translate into increase in global r.
# Why?  Dispersion of rho narrow down, financial globalization?
# What happened to the dispersion of r?  Get sd(r_t) for each t (i.e. across i)

plot(c(1950:2014),pwt9g$kap,  type="l", col="black", lwd=3, main="Global, nw int'l, and uw int'l (Yo-C)/K", sub="Source: PWT 9.0", xlab="Year", ylab=" ", ylim=c(.05,.3))
lines(c(1950:2014), pwt9g$wkap, type="l", lwd=2, col="black")
lines(c(1950:2014), pwt9g$yruwkap, type="l", lwd=1, col="black")
legend("topright", c("Global (Yo-C)/K","Int'l nw (Yo-C)/K","Int'l uw (Yo-C)/K"), lwd=c(3,2,1), col=c("black","black", "black"))
...
library("TTR")
# Unweighted global
pwt9g.ts <- ts(pwt9g, start=1950, end=2014, frequency=1)
str(pwt9g.ts)
summary(pwt9g.ts)


# THIS IS NOT NECESSARY, SINCE pwt9g HAS ALL THE VARIABLES:
# GLOBAL, N-WEIGHTED, AND COUNTRY-WEIGHTED
# N-weighted global
pwt9nwg.ts <- ts(pwt9nwg, start=1950, end=2014, frequency=1) 
str(pwt9nwg.ts)
summary(pwt9nwg.ts)

# Plots of simple moving averages:
# Unweighted global
g_w.ts <- SMA(pwt9g.ts[,"yruwlabsh"], n=5)
g_e.ts <- SMA(pwt9g.ts[,"yruwe"], n=5)
g_c.ts <- SMA(pwt9g.ts[,"yruwc"], n=5)
g_eps.ts <- SMA(pwt9g.ts[,"yruweps"], n=5)
g_rho.ts <- SMA(pwt9g.ts[,"yruwrho"], n=5)
g_r.ts <- SMA(pwt9g.ts[,"yruwr"], n=5)
g_kap.ts <- SMA(pwt9g.ts[,"yruwkap"], n=5)

# N-weighted global
nwg_ww.ts <- SMA(pwt9nwg.ts[,"ww"], n=5)
nwg_we.ts <- SMA(pwt9nwg.ts[,"we"], n=5)
nwg_wc.ts <- SMA(pwt9nwg.ts[,"wc"], n=5)
nwg_weps.ts <- SMA(pwt9nwg.ts[,"weps"], n=5)
nwg_wrho.ts <- SMA(pwt9nwg.ts[,"wrho"], n=5)
nwg_wr.ts <- SMA(pwt9nwg.ts[,"wr"], n=5)
nwg_wkap.ts <- SMA(pwt9nwg.ts[,"wkap"], n=5)

# Plots of time series
plot.ts(pwt9nwg.ts[,"ww"], lwd=2, main="N-weighted omega and SMA5(N-weighted omega)", ylab="W/Y")
lines(nwg_ww.ts, lwd=1, lty=2)
legend("bottomleft", c("N-w W/Y","SMA5(N-w W/Y)"), lwd=c(2,1), lty=c(1,2), col=c("black","black"))

plot.ts(pwt9nwg.ts[,"we"], lwd=2, main="N-weighted e and SMA5(N-weighted e)", ylab="(Y-W)/W")
lines(nwg_we.ts, lwd=1, lty=2)
legend("topleft", c("N-w (Y-W)/W","SMA5(N-w (Y-W)/W)"), lwd=c(2,1), lty=c(1,2), col=c("black","black"))

plot.ts(pwt9nwg.ts[,"wc"], lwd=2, main="N-weighted c and SMA5(N-weighted c)", ylab="C/Yo")
lines(nwg_wc.ts, lwd=1, lty=2)
legend("bottomleft", c("N-w C/Yo","SMA5(N-w C/Yo)"), lwd=c(2,1), lty=c(1,2), col=c("black","black"))

plot.ts(pwt9nwg.ts[,"weps"], lwd=2, main="N-weighted epsilon and SMA5(N-weighted epsilon)", ylab="(Yo-C)/C")
lines(nwg_weps.ts, lwd=1, lty=2)
legend("topleft", c("N-w (Yo-C)/C","SMA5(N-w (Yo-C)/C)"), lwd=c(2,1), lty=c(1,2), col=c("black","black"))

plot.ts(pwt9nwg.ts[,"wrho"], lwd=2, main="N-weighted rho and SMA5(N-weighted rho)", ylab="Y/K")
lines(nwg_wrho.ts, lwd=1, lty=2)
legend("bottomleft", c("N-w Y/K","SMA5(N-w Y/K)"), lwd=c(2,1), lty=c(1,2), col=c("black","black"))

plot.ts(pwt9nwg.ts[,"wr"], lwd=2, main="N-weighted r and SMA5(N-weighted r)", ylab="(Y-W)/K")
lines(nwg_wr.ts, lwd=1, lty=2)
legend("topright", c("N-w (Y-W)/K","SMA5(N-w (Y-W)/K)"), lwd=c(2,1), lty=c(1,2), col=c("black","black"))

plot.ts(pwt9nwg.ts[,"wkap"], lwd=2, main="N-weighted kappa and SMA5(N-weighted kappa)", ylab="(Yo-C)/K")
lines(nwg_wkap.ts, lwd=1, lty=2)
legend("topleft", c("N-w (Yo-C)/K","SMA5(N-w (Yo-C)/K)"), lwd=c(2,1), lty=c(1,2), col=c("black","black"))

# N-weighted global residuals
nwg_wwres.ts <- nwg_ww.ts - pwt9nwg.ts[,"ww"]
nwg_weres.ts <- nwg_we.ts - pwt9nwg.ts[,"we"]
nwg_wcres.ts <- nwg_wc.ts - pwt9nwg.ts[,"wc"]
nwg_wepsres.ts <- nwg_weps.ts - pwt9nwg.ts[,"weps"]
nwg_wrhores.ts <- nwg_wrho.ts - pwt9nwg.ts[,"wrho"]
nwg_wrres.ts <- nwg_wr.ts - pwt9nwg.ts[,"wr"]
nwg_wkapres.ts <- nwg_wkap.ts - pwt9nwg.ts[,"wkap"]

# Plots of residuals
# N-weighted global
plot.ts(nwg_wwres.ts)
abline(h=0, lty=2)
